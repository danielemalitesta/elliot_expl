...
def parse_args():
    ...
    parser.add_argument('--rec', nargs='?', default="ngcf", help="set recommendation model")
    ...
    parser.add_argument('--l_w', type=float, default=1e-5, help='size of low dimensionality')
